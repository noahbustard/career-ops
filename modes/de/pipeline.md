...
Verarbeitet URLs von Stellenanzeigen, die in `data/pipeline.md` gesammelt wurden. Der Kandidat wirft URLs ins Inbox, wann immer er eine entdeckt, und führt später den `pipeline`-Workflow aus, um sie alle in einem Rutsch zu verarbeiten.
